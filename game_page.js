...
quesion_word="<h4 id='word_display'> Q." +remove_charAt3+"</h4>";
input_box= "<br> Answer: <input type='text' id='input_check_box' ";
check_button="<br><br> <button class='btn btn-info' onclick='check()'>Check</button> ";

row=quesion_word+input_box+check_button;
...
function check()
{
get_answer= document.getElementById("input_box");
...
if(answer==word)
{
    ...
    if(answer_turn=="player_1")
    {
        ...
        document.getElementById("player_1_score").innerHTML=player1_score+1;
